...
<!-- 기본값이거나 true일때는 HTML이 해석되지 않고 태그까지 그대로 출력된다. JS의 innerHTML()과 동일함. - -->
<h3>escapeXml=true(기본값)일때</h3>
<c:out value="${htmlStr }" escapeXml="true" />
<br>
\${htmlStr } : ${htmlStr }

<!-- false일때 HTML이 해석되어져서 화면에 출력된다. JS의 innerHTML()과 동일함. -->
