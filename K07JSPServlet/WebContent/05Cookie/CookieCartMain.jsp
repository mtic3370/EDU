...
//문자열을 연결하기 위한 객체를 생성.
/*
가져온 쿠키를 읽어서 만약 쿠키값이 product문자열이 포함되있으면 buffer 참조변수에
문자열을 계속 연결.문자열의 변경이 빈번하게 발생되는 경우 String클래스보다 
StringBuffer 클래스 문자열을 연결한다. 
*/
...
<body>
	...
	<table border=1 cellpadding="10">
		<tr>
			<td>
				<!-- 
				StringBuffer형 문자열에 각 value값이 포함되었는지
				확인해서 있다면 checked속성을 활성화한다. 
				-->
